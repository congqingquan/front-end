...
// ==================== 1. `?` : 可选运算符，告诉编译器变量、属性可能 null 或 undefined ====================
...
let res: string | undefined = obj.name?.toString() // 1. 当 name 为 null 或 undefined 时，res 都为 undefined 2. res 类型为联合类型
let ress: string | undefined = obj.age?.toString() // 当 age 为 null 或 undefined 时，res 都为 undefined
