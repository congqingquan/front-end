...
export async function action({ request, params }) {
    console.log('edit page, request {}, params {}', request, params);
    ...
    console.log(`first: ${first} / last: ${last} / avatar: ${avatar} / notes: ${notes}`);

    for (let fromName in updates) {
        console.log(`${fromName} - ${updates[fromName]}`);
    }
