...
export interface SysMenuTreeProviderData {
...
export interface SysMenuTreeProvider extends Provider {
    data: SysMenuTreeProviderData
}
...
export const initData = async (): Promise<void> => {
    ...
    const menuTreeMap = sysMenuTreeProvider.data.menuTreeMap
    const buttonMap = sysMenuTreeProvider.data.buttonMap
    const menuTree = sysMenuTreeProvider.data.menuTree
    const allTree = sysMenuTreeProvider.data.allTree
...
export const sysMenuTreeProvider: SysMenuTreeProvider = {
    key: ProviderKeys.SYS_MENU_TREE,
    data: {
        allTree: ref<MenuTreeNode[]>([]),
        menuTree: ref<MenuTreeNode[]>([]),
        menuTreeMap: ref<MenuMap>({}),
