...
interface SysUserMenuTreeStore extends Store { 
    // 树：菜单、菜单目录、按钮
...
export const useSysUserMenuTreeStore = defineStore<string, SysUserMenuTreeStore>(PinaKeys.SYS_USER_MENU_TREE,
    () => {
        // state
        ...
        const clear = async () => {
            ...
            buttonMap.value = {}
            // clear disk
            localStorage.removeItem(PinaKeys.SYS_USER_MENU_TREE)
        }
